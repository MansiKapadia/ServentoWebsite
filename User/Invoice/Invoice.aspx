<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Invoice.aspx.cs" Inherits="As_Your_Need_services.User.Invoice.assets.Invoice" %>

<!DOCTYPE html>
<html lang="en">

    
<!-- Mirrored from mannatthemes.com/dastone-1/default/apps-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Apr 2021 04:16:38 GMT -->
<head>
        <meta charset="utf-8" />
                            ...
                            <div class="card">
                                <div class="card-body invoice-head"> 
                                    <div class="row">
                                        <div class="col-md-4 align-self-center">                                                
                                            <img src="../../Servento/Servento-logos_black.png" alt="logo-small" class="logo-sm mr-1" height="150" width="200">                                            
                                            ...
                                            <ul class="list-inline mb-0 contact-detail float-right">                                                   
                                                <li class="list-inline-item">
                                                    <div class="pl-3">
                                                        ...
                                                        <p class="text-muted mb-0">www.servento.com</p><br />
                                                ...
                                                <li class="list-inline-item">
                                                    <div class="pl-3">
                                                        ...
                                                        <p class="text-muted mb-0">2821 Citylight Complex,Citylight,</p>
                                                        <p class="text-muted mb-0">Surat,Gujarat, INDIA.</p>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div><!--end col-->    
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="">
                                                <h6 class="mb-0"><b>Order Date :</b> <asp:Label ID="lbldate" runat="server" ></asp:Label><%--11/05/2020--%></h6>
                                                <h6><b>Order ID :</b><asp:Label ID="lblorderid" runat="server" ></asp:Label> <%--# 23654789--%></h6>
                                            </div>
                                        </div><!--end col--> 
                                       <%-- <div class="col-md-3">                                            
                                        ...
                                        <div class="col-md-3">                                            
                                            <div class="float-left">
                                                <address class="font-13">
                                                    <strong class="font-14">Billed To :</strong><br>
                                                    <%--Joe Smith--%><asp:Label ID="lblname" runat="server" ></asp:Label><br>
                                                    <%--795 Folsom Ave--%>

                                                   <asp:Label ID="lbladd"  runat="server" ></asp:Label> <%--San Francisco, CA 94107--%><br>
                                                    <abbr title="Phone">Contact:</abbr> <%--(123) 456-7890--%><asp:Label ID="lblcontact"  runat="server" Text="mansi" ></asp:Label>
                                                </address>
                                            </div>
                                        </div> <!--end col-->                       
                                    </div><!--end row-->
                                        ...
                                        <div class="col-lg-12">
                                            <div class="table-responsive project-invoice">
                                                <table class="table table-bordered mb-0">
                                                    ...
                                                    <tbody>
                                                        <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:ConnectionString %>' SelectCommand="SELECT Order_mstr.order_id, Order_mstr.user_id, Order_mstr.tamt, Order_mstr.tdate, Order_mstr.status, Order_details_mstr.ordid, Order_details_mstr.order_id AS Expr1, Order_details_mstr.sub_cat_id, Order_details_mstr.sub_cat_price, Sub_Category.sub_cat_name, Sub_Category.sub_cat_desc, Sub_Category.sub_cat_price AS Expr2 FROM Order_mstr INNER JOIN Order_details_mstr ON Order_mstr.order_id = Order_details_mstr.order_id INNER JOIN Sub_Category ON Order_details_mstr.sub_cat_id = Sub_Category.sub_cat_id WHERE (Order_mstr.order_id = @order_id)">
                                                            <SelectParameters>
                                                       ...
                                                       <ItemTemplate>
                                                        <tr>
                                                            <td><%# Eval("ordid") %></td>
                                                            <td>
                                                                <h5 class="mt-0 mb-1 font-14"><%#Eval("sub_cat_name") %></h5>
                                                                <p class="mb-0 text-muted"><%#Eval("sub_cat_desc") %></p>
                                                            </td>
                                                            <td><%#Eval("status") %></td>
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-lg-7 align-self-end">
                                            <div class="float-right" style="width: 30%;">
                                                ...
                                                <img src="../../Servento/Servento-logos_black.png" alt="" class="mt-2 mb-1" height="90" width="90">
                                    ...
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-lg-12 col-xl-4 ml-auto align-self-center">
                                            <div class="text-center"><small class="font-12">Thank you very much for doing servento services with us.</small></div>
                                        </div><!--end col-->
...
<!-- Mirrored from mannatthemes.com/dastone-1/default/apps-invoice.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 06 Apr 2021 04:16:39 GMT -->
</html>