<%@ Page Title="" Language="C#" MasterPageFile="~/User/MasterSerivece.Master" AutoEventWireup="true" CodeBehind="PayNow.aspx.cs" Inherits="As_Your_Need_services.User.WebForm16" %>
              ...
              <div class="aon-page-banner-row" style="background-image: url(images/banner/job-banner.jpg)">
                ...
                <div class="sf-banner-heading-wrap">
                  ...
                  <div class="sf-banner-heading-area">
                    ...
                    <div class="sf-banner-heading-large">Please Click On Paynow</div>
                    ...
                    <div class="sf-contact-form">
                        ...
                        <form  runat="server" >
                            ...
                            <div class="sf-contact-submit-btn">
                              ...
                              <button class="site-button" type="submit"> PayNow </button>
